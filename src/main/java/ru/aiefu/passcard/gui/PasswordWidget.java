...
public class PasswordWidget extends AbstractButtonWidget implements Drawable, Element {
    ...
    public PasswordWidget(TextRenderer textRenderer, int x, int y, int width, int height, Text text) {
        this(textRenderer, x, y, width, height, null, text);
    }

    public PasswordWidget(TextRenderer textRenderer, int x, int y, int width, int height, @Nullable TextFieldWidget copyFrom, Text text) {
    ...
    public void setShowPassword(boolean bl){
        this.showPassword = bl;
    }
    ...
    public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        if (this.isVisible()) {
            ...
            if(!this.showPassword){
                string = StringUtils.repeat("*", string.length());
            }
